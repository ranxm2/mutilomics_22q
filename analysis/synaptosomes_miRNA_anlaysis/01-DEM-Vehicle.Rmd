...
```{r load_bulkRNA_data}
count_mature<- read.csv(here::here("data", "synaptosomes_miRNA", "raw",
                                      "mature_counts.csv"))



rownames(count_mature) <- count_mature$X
count_mature <- count_mature[, -1]
count_mature <-t(count_mature)
rownames(count_mature) <- gsub("\\.", "-", rownames(count_mature))
...
count_mature <- count_mature[, rownames(condition_list)]
...
filter_counts <- count_mature[, rownames(filter_sample_info)]
...
plot_volcano_plot(result_df, 
                  ...
                  thread = 1 ,dot_size =3, label_gene = NULL)

plot_volcano_plot(result_df, 
                  figure_folder = file.path(result_folder,"02-DEG"),
                  file_name = "02_volcano_plot_log2fc_1_with_label_miRNA",
                  thread = 1 , dot_size =3, label_gene = target_miRNA)

plot_volcano_plot(result_df, 
                  figure_folder = file.path(result_folder,"02-DEG"),
                  file_name = "03_volcano_plot_log2fc_1.5",
                  thread = 1.5 ,  dot_size =3,label_gene = NULL)

plot_volcano_plot(result_df, 
                  figure_folder = file.path(result_folder,"02-DEG"),
                  file_name = "03_volcano_plot_log2fc_1.5_with_label_miRNA",
                  thread = 1.5 , dot_size =3, label_gene = target_miRNA)
