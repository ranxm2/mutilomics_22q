...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  message = FALSE,
  fig.path = "./results/02-miRNA-boxplot/Analysis_figure/"
)
...
result_folder = file.path("results", "02-miRNA-boxplot")
...
for (index in 1:length(all_miRNA )){
  ...
  p<-plot_expression_boxplot_4_group(counts_matrix = normalized_count, condition_list_label, feature =  plot_miRNA  ,
